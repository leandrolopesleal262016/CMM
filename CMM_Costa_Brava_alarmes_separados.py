    ...
    while(1):        
        ...
        if (tx1 == 1):    # Se o tx mandou abrir o portão
            ...
            if (tx1 == 1): # Verifica novamente para evitar ruido
                ...
                status = open("/home/pi/CMM/status_garagem1.cmm", "w")  # Para não disparar o arrombamento
                status.write("1")
                status.close()
                ...
                if pmg1 == 0: # Portão abriu
                                ...
                                if pmg1 == 0:
                                    ...
                                    while pmg1 == 0:  # Enquanto o portão ainda não fechou                                
                                        ...
                                        if bar1 == 1: # Dupla passagem
                                            ...
                                            time.sleep(0.2) # Evita ruido
                                            bar1 = l.leitor1_in2() # Faz a leitura da barreira 1 novamente
                    ...
                    if cont == 1: # Passaram se 29 segundos e o portão não fechou
                        ...
                        evento.enviar("E","132","015") # mudar este setor
    ...
    while(1):
        ...
        if (tx2 == 1):    # Se o tx mandou abrir o portão
            ...
            if (tx2 == 1):
                ...
                status = open("/home/pi/CMM/status_garagem2.cmm", "w")  # Para não disparar o arrombamento
                status.write("1")
                status.close()
                ...
                if pmg2 == 0: # Portão abriu
                    ...
                    if cont == 1: # Passaram se 29 segundos e o portão não fechou
                        ...
                        evento.enviar("E","132","016") # Mudar este setor
                        cont = 0
                        break     
        time.sleep(0.2)
        
def Arrombamento(Rele): # Inicia a thread arrombamento de portões sociais
    
    sys.stdout.write("\nPrograma arrombamento de portões sociais em execução\n")
...
def Servidor(Rele,Abre): # Inicia a thread
...
def Alarmes(Rele): # Mudança da Garagem 1 e violação da Garagem e Subsolo
    ...
    while (1):
        ...
        g1 = open("status_garagem1.cmm", "r")
        liberado = g1.read()
        g1.close()

        g2 = open("status_garagem2.cmm", "r")
        liberado2 = g2.read()
        g2.close()
        ...
        pmg2 = l.leitor7_in1()  # Ponto magnetico portão leitor 7 entrada 1
        # mud2 = l.leitor7_in4()  # Chave de mudança subsolo
            ...
            if mud1 == 0:
                ...
                while cont > 0:
                    ...
                    if (pmg1 == 1):  # Portão ja fechou
                        ...
                        status = open("/home/pi/CMM/status_garagem1.cmm", "w")  # Para disparar o arrombamento
                        status.write("0")
                        status.close()
        ...
        if pmg1 == 0 and liberado == "0":  # Violação do portão da garagem
            ...
            if pmg1 == 0 and liberado == "0":  # Verifica novamente para evitar ruidos
        ...
        if pmg2 == 0 and liberado2 == "0":  # Violação do portão do subsolo
