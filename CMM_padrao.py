...
qr1_garagem = cmm.Qrcode("172.20.9.8","0054",4,"garagem_entrada","1") # IP,Cliente,rele,portao,notificar o condfy) - "172.18.34.247","5987",4,"social" ou "eclusa", "1" notificar o condfy do qrcode usado
#qr2 = cmm.Qrcode("172.18.34.250","5987",5,"eclusa") # IP,Cliente,rele,portao) - "172.18.34.247","5987",4,"social" ou "eclusa"
...
#cmm.Monitor()
# Inmicia a classe para atualizar o banco de dados de entradas e saidas para funcionamento do Monitor I/O
...
def thread_qrcode_garagem_1(): # Programa que mantem a conexão com o QR Code
    ...
    qr1.start() # Conecta com o leitor dentro da classe do QR Code

qr_garagem1 = threading.Thread(target=thread_qrcode_garagem_1)
qr_garagem1.start()
