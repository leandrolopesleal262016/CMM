...
##    log("Instanciou a classe Qrcode")
    ...
    def __init__(self,ip,cliente,rele,portao,notifica,leitor,mensagem):
...
##            self.evento.enviar("R","133","015") # Envia fechamento
        ...
        def Acesso():
            ...
            log("Abrindo portão Acesso")
        
            self.rele.pulso(self.out,2) # Pulso para abrir direto o portão sem intertravamento (Eclusa)
            
            mensagem = ("mpg123 /home/pi/CMM/mp3_qr/" + self.mensagem) 
            os.system(mensagem)            
...
##            os.system("mpg123 /home/pi/CMM/mp3/abrindo_eclusa.mp3")
        ...
        def brinquedoteca():                   
            ...
            log("Abrindo portão brinquedoteca")
...
##            os.system("mpg123 /home/pi/CMM/mp3/abrindo_eclusa.mp3")
        ...
        def bicicletario():                   
            ...
            log("Abrindo portão bicicletario")
...
##            os.system("mpg123 /home/pi/CMM/mp3/abrindo_eclusa.mp3")
        ...
        def churrasqueira():                   
            ...
            log("Abrindo portão churrasqueira")
...
##            os.system("mpg123 /home/pi/CMM/mp3/abrindo_eclusa.mp3")
        ...
        def sala_jogos():                   
            ...
            log("Abrindo portão Sala de Jogos")
...
##            os.system("mpg123 /home/pi/CMM/mp3/abrindo_eclusa.mp3")
        ...
        def sala_festas():                   
            ...
            log("Abrindo portão Sala de Festas")
...
##            os.system("mpg123 /home/pi/CMM/mp3/abrindo_eclusa.mp3")
        ...
        def sala_restrita():                   
            ...
            log("Abrindo portão Sala de Restrita")
...
##            os.system("mpg123 /home/pi/CMM/mp3/abrindo_eclusa.mp3")
        ...
        def sala_reuniao():                   
            ...
            log("Abrindo portão Sala de Reunião")
            ...
            while(1):
                ...
                try: 
                    ...
                    if (tamanho >= 8 and tamanho < 16): # Se tiver o tamanho exato, prossegue
                        ...
                        txt = ("Dados lidos pelo leitor",self.leitor, dados)
                        log(txt)
...
##                        log(txt)
                        ...
                        if (1):
                            ...
                            for item in tabela:
                                ...
                                try:  # Tenta conectar com o banco de dados
                                    ...
                                    txt = ("Opa, problema com o banco de dados",err)                                                                              
                                    log(txt)
                    ...
                    txt = ("Não foi possivel ler os dados recebidos, erro: " + str(e))
                    log(txt)
                    
                if consulta == 0:
                    
                    txt = ("QR Code em formato invalido, texto:",dados)
                    log(txt)
                     
                    os.system("mpg123 /home/pi/CMM/mp3/qr_formato_invalido.mp3")#  Formato de QR Code inválido                    
...
##                                    value = datetime.timedelta(val1,val2)
                            ...
                            # Calculos para verificar a compatibilidade do código dinamico com o horario
                                ...
                                #log("Posição do multiplicador valido",tabela.index(item))
                                #log("Minutos equivalente",minutos_equivalentes)
                                ...
                                #log("confere_tabela",confere_tabela,type(confere_tabela), "\nhorario_atual",horario_atual,type(horario_atual))
...
##                                    log("Esta com menos de 15 min de diferenca")
                                    liberado = '1' 
...
##                                            os.system("mpg123 /home/pi/CMM/mp3/bemvindo_LagoSul.mp3")                                        
                                            ...
                                            if self.notifica == "1":
                                                ...
                                                try:
                                                    ...
                                                    log("Tentando notificar o Condfy...")                                                
                                                    self.avisa_condfy.qr_utilizado(self.cliente,self.id_raiz)
                                                    
                                                except Exception as err:
                                                    
                                                    txt = ("Erro ao notificar o Condfy\n",err)
                                                    log(txt)
...
##                                        self.banco.deleta("qrcode", "id", self.id_raiz)
                                    ...
                                    if (self.portao == "acesso"):                                        

                                        log ("Acesso por qr code Portão Acesso")
                                        Acesso()
                                    ...
                                    if (self.portao == "academia"):

                                        log ("Acesso por qr code Academia")
                                        academia()
                                    ...
                                    if (self.portao == "brinquedoteca"):

                                        log ("Acesso por qr code Brinquedoteca")
                                        brinquedoteca()
                                    ...
                                    if (self.portao == "bicicletario"):

                                        log ("Acesso por qr code Bicicletario")
                                        bicicletario()
                                    ...
                                    if (self.portao == "churrasqueira"):

                                        log ("Acesso por qr code Churrasqueira")
                                        churrasqueira()
                                    ...
                                    if (self.portao == "hall_1"):

                                        log ("Acesso por qr code Hall 1")
                                        hall1()
                                    ...
                                    if (self.portao == "hall_2"):

                                        log ("Acesso por qr code Hall 2")
                                        hall2()
                                    ...
                                    if (self.portao == "jogos"):

                                        log ("Acesso por qr code Sala de Jogos")
                                        sala_jogos()
                                    ...
                                    if (self.portao == "festa"):

                                        log ("Acesso por qr code Salão de festas")
                                        sala_festas()
                                    ...
                                    if (self.portao == "restrita"):

                                        log ("Acesso por qr code Sala Restrita")
                                        sala_restrita()
                                    ...
                                    if (self.portao == "reuniao"):

                                        log ("Acesso por qr code Sala Reunião")
                                        sala_reuniao()
                                    ...
                                    if (self.portao == "garagem_1"):

                                        log ("Acesso por qr code Garagem 1")
                                        garagem1()
                                    ...
                                    if (self.portao == "garagem_2"):

                                        log ("Acesso por qr code Garagem 2")
                                        garagem2()
                                    ...
                                    if (self.portao == "garagem_3"):

                                        log ("Acesso por qr code Garagem 3")
                                        garagem3()
                            ...
                            if acesso == 0 and consta_no_banco == 1 and fora_do_horario == 0:
                                ...
                                os.system("mpg123 /home/pi/CMM/mp3/qr_data_expirou.mp3")# Data Expirada                                
                                consulta = 1
